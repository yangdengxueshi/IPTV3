...
public class IptvConfig {
    ...
    public static final String VOD_PATH = "/iptv2/vod/";
    public static final int DEFAULT_RTSP_PORT = 554;// 默认RTSP端口
    public static final String IPTV_PACKAGE = "com.dexin.iptv2";
